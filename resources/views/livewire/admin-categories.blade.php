    ...
    <x-jet-dialog-modal wire:model="open_edit">
        ...
        <x-slot name="content">
            ...
            <div class="mb-4">
                ...
                <x-jet-input type="text" wire:model="category.nombre_en" class="w-full" />
            </div>
        ...
        <x-slot name="footer">
            <x-jet-danger-button wire:click="update" wire:loading.attr="disabled" wire:target="save" class="mr-2">
                Guardar
            </x-jet-danger-button>
